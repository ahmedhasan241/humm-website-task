<template>
  <div class="container mt-5">
    ...
    >
      <div class="col">
        <div class="card text-end border border-2 border-dark">
          <svg
            class="mt-3 mx-3"
          ...
          <div class="card-body">
            <h5 class="card-title">محبة للطعام</h5>
            <p class="card-text">
              همم هو عالم لكل ما يتعلق بالطعام وأسلوب الحياة - هنا، ستجد كل ما
              تحتاجه لإعداد طعام رائع، والعثور على هدايا رائعة، ولتدليل نفسك،
              والارتقاء بمنزلك. يتم استيراد الكثير من منتجاتنا وحزمنا، لذلك لن
              تجدها في أي مكان آخر - تابعونا حيث يأتي المزيد والمزيد من المنتجات
              إلى humm.world كل يوم، من جميع أنحاء العالم.
            </p>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="card text-end border border-2 border-dark">
          ...
          <div class="card-body">
            <h5 class="card-title">جرب طعمًا جديدًا</h5>
            <p class="card-text">
              همم هو عالم لكل ما يتعلق بالطعام وأسلوب الحياة - هنا، ستجد كل ما
              تحتاجه لإعداد طعام رائع، والعثور على هدايا رائعة، ولتدليل نفسك،
              والارتقاء بمنزلك. يتم استيراد الكثير من منتجاتنا وحزمنا، لذلك لن
      ...
      <div class="col">
        <div class="card text-end border border-2 border-dark">
          ...
          <div class="card-body">
            <h5 class="card-title">روح المغامرة</h5>
            <p class="card-text">
              همم هو عالم لكل ما يتعلق بالطعام وأسلوب الحياة - هنا، ستجد كل ما
              تحتاجه لإعداد طعام رائع، والعثور على هدايا رائعة، ولتدليل نفسك،
              والارتقاء بمنزلك. يتم استيراد الكثير من منتجاتنا وحزمنا، لذلك لن
